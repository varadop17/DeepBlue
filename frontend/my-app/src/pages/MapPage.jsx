...
//       // Add a default marker at the user's current location
//       L.marker([currentPosition.latitude, currentPosition.longitude]).addTo(mapInstance)
//         .bindPopup('Your location')
//         .openPopup();

//       // Set the map state to the initialized map
//       setMap(mapInstance);
//     }
//   }, [currentPosition]);
...
//       ></div>
//       {/* If you want to go back to the pickup locations page */}
//       <button onClick={() => navigate('/pickup')}>Go Back to Pickup Locations</button>
//     </div>
//   );
// };

// export default MapPage;
//final code where map was displayed
...
//       const userMarker = L.marker([currentPosition.latitude, currentPosition.longitude]).addTo(mapInstance)
//         .bindPopup('Your location')
//         .openPopup();
